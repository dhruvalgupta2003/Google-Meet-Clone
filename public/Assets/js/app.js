var AppProcess = (function () {
  ...
  function removeMediaSenders(rtp_senders) {
    for (var conn_id in peers_connection_ids) {
      if (
        rtp_senders[conn_id] &&
        connection_status(peers_connection[conn_id])
      ) {
  ...
  return {
    ...
    closeConnectionCall: async function (data) {
      await closeConnection(data);
    },
  };
})();
  ...
  function addUser(other_user_id, connId, userNumb) {
    ...
    $(".in-call-wrap-up").append(
      '<div class="in-call-wrap d-flex justify-content-between align-items-center mb-3" id="participant_' +
        connId +
        '"> <div class="participant-img-name-wrap display-center cursor-pointer"> <div class="participant-img"> <img src="public/Assets/images/other-img1.webp" alt="" class="border border-secondary" style="height:40px; width: 40px; border-radius: 50%;"> </div> <div class="participant-name ml-2">' +
        other_user_id +
        '</div></div> <div class="participant-action-wrap display-center"> <div class="participant-action-dot diplay-center mr-2 cursor-pointer"> <span class="material-icons"> more_vert </span> </div> <div class="participant-action-pin diplay-center mr-2 cursor-pointer"> <span class="material-icons"> push_pin </span> </div> </div></div>'
    );
